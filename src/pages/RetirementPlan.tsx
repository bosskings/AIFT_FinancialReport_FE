  ...
  return (
    <div className="bg-white h-full flex flex-col shadow-sm border-r border-gray-100">
      <div className="px-6 pt-8 pb-6 border-b border-gray-100 flex items-start justify-between">
        ...
        {props.onClose && (
          <button onClick={props.onClose} className="lg:hidden p-1 rounded-lg hover:bg-gray-100 text-gray-500">
                ...
                <div className={"flex items-center gap-3 py-2.5 px-3 rounded-md transition-all duration-200 " + (isActive ? "bg-blue-50" : isPast || isCompleted ? "opacity-80" : "opacity-40")}>
                  <div className="w-4 h-4 rounded-full flex items-center justify-center shrink-0" style={{ backgroundColor: isActive ? NAVY : isCompleted || isPast ? "#22c55e" : "#e5e7eb" }}>
                    {isCompleted || (isPast && !isActive)
                      ...
                      : <span style={{ fontSize: "9px", fontWeight: "bold", color: isActive ? "white" : "#9ca3af" }}>{index + 1}</span>
                    }
                  </div>
                  <span className="text-xs font-semibold block truncate" style={{ color: isActive ? NAVY : isPast || isCompleted ? "#374151" : "#9ca3af" }}>
                    {step.label}
                  </span>
                </div>
              </li>
      ...
      <div className="px-5 pb-6 border-t border-gray-100 pt-4 space-y-3">
        <button className="flex items-center gap-2 text-gray-500 hover:text-gray-700 transition-colors">
          <Ico d={P.help} sz="w-4 h-4" /><span className="text-xs font-medium">Help Center</span>
        </button>
        <button className="flex items-center gap-2 text-gray-500 hover:text-gray-700 transition-colors">
          <Ico d={P.cog} sz="w-4 h-4" /><span className="text-xs font-medium">Settings</span>
        </button>
      </div>
    </div>
  );
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
            <FieldWrap label="Full Name" hint="Enter your full legal name as it appears on documents.">
              ...
              <input
                ...
                onChange={function (e: any) { setData(function (p: any) { return Object.assign({}, p, { fullName: e.target.value }); }); }}
            ...
            <FieldWrap label="Date of Birth" hint="Used to calculate your current age and retirement timeline.">
              ...
              <input
                ...
                required
                max={maxDobStr}
                onChange={function (e: any) { setData(function (p: any) { return Object.assign({}, p, { dob: e.target.value }); }); }}
                className={INP_BASE + " pl-10 pr-4"}
                onFocus={focusNavy}
                onBlur={blurGray}
              />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
            <FieldWrap label="Marital Status" hint="Affects Social Security and tax calculations.">
              ...
              <select
                ...
                required
                onChange={function (e: any) { setData(function (p: any) { return Object.assign({}, p, { maritalStatus: e.target.value }); }); }}
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
            <FieldWrap label="Annual Gross Salary" hint="Total yearly earnings before taxes and deductions.">
              ...
              <input
                ...
                required
                placeholder="95,000"
                onChange={function (e: any) { var v = fmtNum(e.target.value); setData(function (p: any) { return Object.assign({}, p, { grossSalary: v }); }); }}
          ...
          <div className="mb-8">
            <InfoBox title="Social Security Impact">
              Accurate income reporting is critical for your retirement plan. We use these figures to estimate your future Social Security payments based on your current tax contributions.
            </InfoBox>
          </div>
...
function Plans(props: any) {
  ...
  function togglePlan(type: any) {
    setData(function (p: any) {
      var next = p.planTypes.indexOf(type) !== -1
        ? p.planTypes.filter(function (t: any) { return t !== type; })
        : p.planTypes.concat(type);
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-2 gap-3">
            <RadioToggle
              ...
              onClick={function () { setData(function (p: any) { return Object.assign({}, p, { participates: true }); }); }}
            />
            <RadioToggle
              label="No, I do not"
              on={data.participates === false}
              onClick={function () { setData(function (p: any) { return Object.assign({}, p, { participates: false }); }); }}
            />
          </div>
        </div>
        {data.participates && (
          <form onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
              <div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  {planOptions.map(function (opt: any) {
              ...
              <FieldWrap label="Current Total Balance ($)" hint="Total saved amount across all selected plans.">
                ...
                <input
                  ...
                  placeholder="0"
                  onChange={function (e: any) { var v = fmtNum(e.target.value); setData(function (p: any) { return Object.assign({}, p, { planBalance: v }); }); }}
                  className={INP_BASE + " pl-10 pr-4"}
                  onFocus={focusNavy}
                  onBlur={blurGray}
                />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
              <div>
                ...
                <div className="flex">
                  <div className="flex border border-gray-200 rounded-l-lg overflow-hidden shrink-0" style={{ borderRight: "none" }}>
                    {["%", "$"].map(function (unit: any) {
                      return (
                        <button
                          key={unit}
                          type="button"
                          onClick={function () { setData(function (p: any) { return Object.assign({}, p, { contribUnit: unit }); }); }}
                  ...
                  <input
                    ...
                    min="0"
                    max={data.contribUnit === "%" ? "100" : undefined}
                    step="0.5"
                    placeholder="8"
                    onChange={function (e: any) { setData(function (p: any) { return Object.assign({}, p, { contribRate: e.target.value }); }); }}
              ...
              <FieldWrap label="Employer Match" hint="Match percentage based on your deferral.">
                ...
                <select
                  value={data.empMatch}
                  onChange={function (e: any) { setData(function (p: any) { return Object.assign({}, p, { empMatch: e.target.value }); }); }}
                  className={INP_BASE + " pl-10 pr-10 appearance-none"}
                  onFocus={focusNavy}
                  onBlur={blurGray}
                >
                ...
                <div className="rounded-lg border border-gray-200 px-4 py-3" style={{ backgroundColor: "#fafafa" }}>
                  ...
                  <div className="flex items-center gap-4">
                    <RadioInline
                      ...
                      onClick={function () { setData(function (p: any) { return Object.assign({}, p, { contUntilRet: true }); }); }}
                    />
                    <RadioInline
                      label="No"
                      on={data.contUntilRet === false}
                      onClick={function () { setData(function (p: any) { return Object.assign({}, p, { contUntilRet: false }); }); }}
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 rounded-xl px-5 py-4" style={{ backgroundColor: NAVYLT, border: "1px solid " + NAVYBD }}>
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 leading-relaxed">
                    Financial advisers recommend contributing at least enough to capture your full employer match — effectively a 100% or 50% guaranteed return before market performance.
                  </p>
                </div>
              </div>
            </div>
...
function IRAs(props: any) {
  ...
  function toggleIraType(type: any) {
    setData(function (p: any) {
      var next = p.iraTypes.indexOf(type) !== -1
        ? p.iraTypes.filter(function (t: any) { return t !== type; })
        : p.iraTypes.concat(type);
  ...
  function toggleSrc(src: any) {
    setData(function (p: any) {
      ...
      var without = p.incomeSrc.filter(function (s: any) { return s !== "none"; });
      var next = without.indexOf(src) !== -1
        ? without.filter(function (s: any) { return s !== src; })
        : without.concat(src);
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center gap-6">
              <RadioInline
                label="Yes"
                on={data.hasIRA === true}
                onClick={function () { setData(function (p: any) { return Object.assign({}, p, { hasIRA: true }); }); }}
              />
              <RadioInline
                label="No"
                on={data.hasIRA === false}
                onClick={function () { setData(function (p: any) { return Object.assign({}, p, { hasIRA: false }); }); }}
              />
            </div>
          </div>
          {data.hasIRA && (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <FieldWrap label="Total IRA Balance" hint="Current combined value of all your IRAs.">
                  ...
                  <input
                    ...
                    value={data.iraBal}
                    placeholder="0"
                    onChange={function (e: any) { var v = fmtNum(e.target.value); setData(function (p: any) { return Object.assign({}, p, { iraBal: v }); }); }}
                    className={INP_BASE + " pl-10 pr-4"}
                    onFocus={focusNavy}
                    onBlur={blurGray}
                  />
                ...
                <FieldWrap label="Annual IRA Contributions" hint="Planned yearly contributions for this calendar year.">
                  ...
                  <input
                    ...
                    placeholder="0"
                    onChange={function (e: any) { var v = fmtNum(e.target.value); setData(function (p: any) { return Object.assign({}, p, { iraContrib: v }); }); }}
                    className={INP_BASE + " pl-10 pr-4"}
                    onFocus={focusNavy}
                    onBlur={blurGray}
                  />
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-7">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                placeholder="85,000"
                onChange={function (e: any) { var v = fmtNum(e.target.value); setData(function (p: any) { return Object.assign({}, p, { retirementIncome: v }); }); }}
          ...
          <div className="mb-7">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              {lifestyleOpts.map(function (opt: any) {
                var on = data.lifestyle === opt.id;
                return (
                  <button
                    key={opt.id}
                    type="button"
                    onClick={function () { setData(function (p: any) { return Object.assign({}, p, { lifestyle: opt.id }); }); }}
          ...
          <div className="mb-7">
            ...
            <div className="flex gap-2">
              {[1, 2, 3, 4, 5].map(function (n: any) {
                return (
                  <button
                    key={n}
                    type="button"
                    onClick={function () { setData(function (p: any) { return Object.assign({}, p, { confidence: n }); }); }}
          ...
          <div className="mb-7">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              {inflationOpts.map(function (opt: any) {
                return (
                  <button
                    key={opt.id}
                    type="button"
                    onClick={function () { setData(function (p: any) { return Object.assign({}, p, { inflation: opt.id, inflationRate: opt.rate }); }); }}
...
function Review(props: any) {
  ...
  var generateReport: any = props.generateReport;
  var isLoading: any = props.isLoading;
          ...
          <div className="flex justify-center mb-6">
            <div className="relative w-16 h-16">
              <svg className="w-16 h-16 -rotate-90" viewBox="0 0 64 64">
                ...
                <circle
                  cx="32" cy="32" r="28" fill="none" stroke={NAVY} strokeWidth="4"
      ...
      <div className="w-full max-w-xl">
        ...
        <Card cls="p-6 sm:p-8">
          ...
          <div
            ...
            onClick={function () { setAgreed(function (v: any) { return !v; }); }}
          >
            <div
...
export default function RetirementPlan() {
  ...
  var [completedSteps, setCompletedSteps] = useState<any[]>([]);
  ...
  var stepIds = STEPS.map(function (s: any) { return s.id; });
  ...
  var currentLabel = (STEPS.find(function (s: any) { return s.id === currentStep; }) || { label: "" }).label;
  ...
  return (
    <div className="py-10">
      ...
      {/* Main content */}
      <main className="lg:pl-64 mx-auto justify-center">
