...
/* ─── Primitive: SVG icon ────────────────────────────────────────────────────── */
function Ico(props) {
  var sz = props.sz || "w-4 h-4";
  var st = props.st || "currentColor";
  var fl = props.fl || "none";
  var sw = props.sw || 2;
  return (
    <svg className={sz} fill={fl} stroke={st} viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={sw} d={props.d} />
    </svg>
  );
}
...
function focusNavy(e) { e.target.style.borderColor = NAVY; }
function blurGray(e) { e.target.style.borderColor = "#e5e7eb"; }

/* ─── Shared small components ────────────────────────────────────────────────── */
function Card(props) {
  return (
    <div className={"bg-white rounded-2xl shadow-sm " + (props.cls || "")}>
      {props.children}
    </div>
  );
}
...
function InfoBox(props) {
  return (
    <div className="flex items-start gap-3 rounded-xl px-5 py-4"
      style={{ backgroundColor: NAVYLT, border: "1px solid " + NAVYBD }}>
      <div className="shrink-0 mt-0.5" style={{ color: NAVY }}>
        <Ico d={P.shield} sz="w-5 h-5" />
      </div>
      <div>
        <p className="text-xs font-bold tracking-widest uppercase mb-1" style={{ color: NAVY }}>
          {props.title}
        </p>
...
function InpIcon(props) {
  return (
    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none">
      <Ico d={props.d} sz="w-4 h-4" />
    </span>
  );
}
...
function RadioToggle(props) {
  return (
    <button
      ...
      style={
        props.on
          ? { borderColor: NAVY, backgroundColor: NAVYLT, color: NAVY }
    ...
    >
      ...
      <div
        ...
        style={{ borderColor: props.on ? NAVY : "#d1d5db" }}
      >
...
function RadioInline(props) {
  return (
    <button
      type="button"
      onClick={props.onClick}
      className="flex items-center gap-2 text-sm font-medium transition-colors"
      style={{ color: props.on ? NAVY : "#6b7280" }}
    >
      <div
    ...
    <div className="bg-white h-full flex flex-col shadow-sm border-r border-gray-100">
      ...
      <div className="px-6 pt-8 pb-6 border-b border-gray-100 flex items-start justify-between">
        <div>
          ...
          <p className="text-gray-400 text-xs font-semibold tracking-widest uppercase pl-9">
      ...
      <div className="px-6 pt-5 pb-3">
        <p className="text-xs font-bold tracking-widest text-gray-400 uppercase mb-1">Your Progress</p>
        ...
        <p className="text-xs text-gray-400 mt-1.5">Step {currentIndex + 1} of {STEPS.length}</p>
      </div>
              ...
              <li key={step.id}>
                <div
                  className={
                    ...
                    (isActive
                      ? "bg-blue-50 border-l-4 border-[#1a3260]"
                      : isPast || isCompleted
                        ? "opacity-80"
                        : "opacity-40")
                  }
                >
                  ...
                  >
                    {isCompleted || (isPast && !isActive) ? (
                      <Ico d={P.check} sz="w-3 h-3" st="white" sw={3} />
                    ) : (
                      <span
                        style={{ fontSize: "9px", fontWeight: "bold", color: isActive ? "white" : "#9ca3af" }}
                      >
                        {index + 1}
                      </span>
                    )}
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {isActive && (
                      <span style={{ fontSize: "9px", color: NAVY, fontWeight: "600" }}>
                        In Progress
                      </span>
                    )}
                  </div>
  ...
  return (
    <div>
      ...
      <p className="text-gray-500 text-sm leading-relaxed mb-6 max-w-xl">
        Let's start with the basics. This information allows us to customize your retirement
        projections based on your unique life situation.
      </p>
      ...
      <Card cls="p-6 sm:p-10">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-7">
            <FieldWrap label="Marital Status" hint="Affects Social Security and tax calculations.">
              ...
              <select
                ...
                className={INP_BASE + " pl-10 pr-10 appearance-none"}
                onFocus={focusNavy}
                onBlur={blurGray}
              >
          ...
          <div className="mb-7">
            <InfoBox title="Privacy Guaranteed">
              Your personal details are used solely for generating your retirement report. We use
              enterprise-grade encryption to protect all your data.
            </InfoBox>
          </div>
...
function Income(props) {
  ...
  return (
    <div>
      ...
      <p className="text-gray-500 text-sm leading-relaxed mb-6 max-w-xl">
        Enter your current earnings to help us estimate your retirement lifestyle and calculate
      ...
      <Card cls="p-6 sm:p-10">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
            <FieldWrap label="Annual Gross Salary" hint="Total yearly earnings before taxes and deductions.">
              ...
              <input
                ...
                placeholder="0"
                onChange={function (e) {
                  var v = fmtNum(e.target.value);
                  setData(function (p) { return Object.assign({}, p, { grossSalary: v }); });
                }}
            ...
            <FieldWrap label="Other Annual Income" hint="Rental income, dividends, side businesses, or other sources.">
              ...
              <input
                ...
                onChange={function (e) {
                  var v = fmtNum(e.target.value);
                  setData(function (p) { return Object.assign({}, p, { otherIncome: v }); });
                }}
                className={INP_BASE + " pl-10 pr-4"}
                onFocus={focusNavy}
                onBlur={blurGray}
          ...
          <div className="mb-8">
            <InfoBox title="Social Security Impact">
              Accurate income reporting is critical for your retirement plan. We use these figures to
              estimate your future Social Security payments based on your current tax contributions.
            </InfoBox>
          </div>
...
function Plans(props) {
  ...
  function togglePlan(type) {
    setData(function (p) {
      var prev = p.planTypes;
      var next = prev.indexOf(type) !== -1
        ? prev.filter(function (t) { return t !== type; })
        : prev.concat(type);
  ...
  return (
    <div>
      ...
      <p className="text-gray-500 text-sm leading-relaxed mb-6 max-w-lg">
        Workplace retirement accounts are often the foundation of financial security. Tell us about
        your current employer-sponsored plans.
      </p>
      ...
      <Card cls="p-6 sm:p-8">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-2 gap-3">
            <RadioToggle
              label="Yes, I participate"
              on={data.participates === true}
              onClick={function () { setData(function (p) { return Object.assign({}, p, { participates: true }); }); }}
            />
            <RadioToggle
              label="No, I do not"
              on={data.participates === false}
              onClick={function () { setData(function (p) { return Object.assign({}, p, { participates: false }); }); }}
            />
          </div>
        </div>
        ...
        {data.participates && (
          <form onSubmit={handleSubmit}>
            <div
              ...
              style={{ borderLeft: "3px solid " + NAVY, paddingLeft: "12px" }}
            >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
                  ...
                  {planOptions.map(function (opt) {
                    ...
                    return (
                      <button
                        key={opt.id}
                        type="button"
                        onClick={function () { togglePlan(opt.id); }}
              ...
              <FieldWrap label="Current Total Balance ($)" hint="Total saved amount across all selected plans.">
                ...
                <input
                  type="text"
                  value={data.planBalance}
                  onChange={function (e) {
                    var v = fmtNum(e.target.value);
                    setData(function (p) { return Object.assign({}, p, { planBalance: v }); });
                  }}
                  className={INP_BASE + " pl-10 pr-4"}
                  onFocus={focusNavy}
                  onBlur={blurGray}
                    ...
                    {["%", "$"].map(function (unit) {
                      return (
                        <button
                          key={unit}
                          type="button"
                          onClick={function () { setData(function (p) { return Object.assign({}, p, { contribUnit: unit }); }); }}
                          className="px-3 py-3 text-xs font-semibold transition-all"
                          style={data.contribUnit === unit
              ...
              <div>
                ...
                <div className="rounded-lg border border-gray-200 px-4 py-3" style={{ backgroundColor: "#fafafa" }}>
                  ...
                  <div className="flex items-center gap-4">
                    <RadioInline
                      label="Yes, until then"
                      on={data.contUntilRet === true}
                      onClick={function () { setData(function (p) { return Object.assign({}, p, { contUntilRet: true }); }); }}
                    />
                    <RadioInline
                      label="No"
                      on={data.contUntilRet === false}
                      onClick={function () { setData(function (p) { return Object.assign({}, p, { contUntilRet: false }); }); }}
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 rounded-xl px-5 py-4"
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 leading-relaxed">
                    Financial advisers recommend contributing at least enough to capture your full employer
                    match — effectively a 100% or 50% guaranteed return before market performance.
                  </p>
                </div>
              </div>
            </div>
...
function IRAs(props) {
  ...
  function toggleSrc(src) {
    setData(function (p) {
      ...
      var next = without.indexOf(src) !== -1
        ? without.filter(function (s) { return s !== src; })
        : without.concat(src);
  ...
  return (
    <div>
      ...
      <p className="text-gray-500 text-sm leading-relaxed mb-6 max-w-lg">
        Manage your individual retirement accounts and additional savings to get a complete picture
      ...
      <Card cls="p-6 sm:p-8">
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center gap-6">
              <RadioInline
                label="Yes"
                on={data.hasIRA === true}
                onClick={function () { setData(function (p) { return Object.assign({}, p, { hasIRA: true }); }); }}
              />
              <RadioInline
                label="No"
                on={data.hasIRA === false}
                onClick={function () { setData(function (p) { return Object.assign({}, p, { hasIRA: false }); }); }}
              />
            </div>
          </div>
                  ...
                  {iraOpts.map(function (opt) {
                    return (
                      <CheckBtn
                        key={opt.id}
                        label={opt.label}
                        on={data.iraTypes.indexOf(opt.id) !== -1}
                        onClick={function () { toggleIraType(opt.id); }}
                      />
                    );
                  })}
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <FieldWrap label="Total IRA Balance" hint="Current combined value of all your IRAs.">
                  ...
                  <input
                    ...
                    onChange={function (e) {
                      var v = fmtNum(e.target.value);
                      setData(function (p) { return Object.assign({}, p, { iraBal: v }); });
                    }}
                    className={INP_BASE + " pl-10 pr-4"}
                    onFocus={focusNavy}
                    onBlur={blurGray}
                ...
                <FieldWrap label="Annual IRA Contributions" hint="Planned yearly contributions for this calendar year.">
                  ...
                  <input
                    type="text"
                    value={data.iraContrib}
                    onChange={function (e) {
                      var v = fmtNum(e.target.value);
                      setData(function (p) { return Object.assign({}, p, { iraContrib: v }); });
                    }}
                    className={INP_BASE + " pl-10 pr-4"}
                    onFocus={focusNavy}
                    onBlur={blurGray}
          ...
          <div className="mb-6">
            ...
            <FieldWrap
              label="Taxable Savings or Brokerage Accounts (optional)"
              hint="Enter value of non-retirement investment accounts."
            >
              <InpIcon d={P.trend} />
              <input
                type="text"
                ...
                onChange={function (e) {
                  var v = fmtNum(e.target.value);
                  setData(function (p) { return Object.assign({}, p, { taxSavings: v }); });
                }}
                className={INP_BASE + " pl-10 pr-4"}
                onFocus={focusNavy}
                onBlur={blurGray}
                ...
                {srcOpts.map(function (opt) {
                  ...
                  return (
                    <button
                      key={opt.id}
                      type="button"
                      onClick={function () { toggleSrc(opt.id); }}
...
function Goals(props) {
  ...
  var confLabels = { 1: "Not at all", 3: "Somewhat", 5: "Very Confident" };

  return (
    <div>
      <h1 className="text-2xl sm:text-3xl font-extrabold text-gray-900 mb-2">Define Your Retirement Goals</h1>
      <p className="text-gray-500 text-sm leading-relaxed mb-6 max-w-lg">
        Visualizing your future helps us create a more accurate roadmap. Tell us about the lifestyle
        you envision and your current outlook.
      </p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-7">
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={function (e) {
                  var v = fmtNum(e.target.value);
                  setData(function (p) { return Object.assign({}, p, { retirementIncome: v }); });
                }}
                className={INP_BASE + " pl-9 pr-4"}
                onFocus={focusNavy}
                onBlur={blurGray}
              />
            </div>
              ...
              {lifestyleOpts.map(function (opt) {
                ...
                return (
                  <button
                    key={opt.id}
                    type="button"
                    onClick={function () { setData(function (p) { return Object.assign({}, p, { lifestyle: opt.id }); }); }}
                    className="flex flex-col items-start text-left p-4 rounded-xl border-2 transition-all"
                    style={on
                      ? { borderColor: NAVY, backgroundColor: NAVYLT }
                      : { borderColor: "#e5e7eb", backgroundColor: "white" }}
                  >
                    <span className="mb-3" style={{ color: on ? NAVY : "#9ca3af" }}>
                      <Ico d={opt.d} sz="w-5 h-5" />
                    </span>
                    <p className="text-sm font-bold mb-1.5" style={{ color: on ? NAVY : "#1f2937" }}>
                      {opt.label}
                    </p>
              ...
              {[1, 2, 3, 4, 5].map(function (n) {
                return (
                  <div key={n} className="flex flex-col items-center" style={{ width: "18%" }}>
                    {confLabels[n] && (
                      <span className="text-xs font-semibold tracking-widest text-gray-400 uppercase mb-1 text-center hidden sm:block">
                        {confLabels[n]}
                      </span>
                    )}
                  </div>
              ...
              {[1, 2, 3, 4, 5].map(function (n) {
                return (
                  <button
                    key={n}
                    type="button"
                    onClick={function () { setData(function (p) { return Object.assign({}, p, { confidence: n }); }); }}
                    className="flex-1 py-3.5 rounded-lg border-2 text-sm font-bold transition-all"
                    style={data.confidence === n
                      ? { borderColor: NAVY, backgroundColor: NAVYLT, color: NAVY }
                      : { borderColor: "#e5e7eb", backgroundColor: "white", color: "#6b7280" }}
                  >
                    {n}
          ...
          <div className="mb-7">
            ...
            <p className="text-xs text-gray-400 mb-3">
              How would you like to model future cost-of-living increases?
            </p>
              ...
              {inflationOpts.map(function (opt) {
                return (
                  <button
                    key={opt.id}
                    type="button"
                    onClick={function () { setData(function (p) { return Object.assign({}, p, { inflation: opt.id, inflationRate: opt.rate }); }); }}
                    className="flex-1 py-3 px-3 rounded-lg border-2 text-sm font-semibold transition-all text-center"
                    style={data.inflation === opt.id
                      ? { borderColor: NAVY, backgroundColor: NAVYLT, color: NAVY }
                      : { borderColor: "#e5e7eb", backgroundColor: "white", color: "#6b7280" }}
                  >
                    {opt.label}
...
function Review(props) {
  ...
  var streams = [
    { label: "Social Security", amount: "$4,200 / mo", pct: 28, color: NAVY },
      ...
      <div className="flex flex-col items-center justify-center min-h-64 py-12">
        <Card cls="w-full max-w-2xl p-8 sm:p-10 text-center">
          ...
          <div className="flex items-center justify-center divide-x divide-gray-200">
            <span className="flex items-center gap-1.5 text-xs text-gray-400 px-4">
              <Ico d={P.lock} sz="w-3.5 h-3.5" /> Securing Your Data
            </span>
            <span className="flex items-center gap-1.5 text-xs text-gray-400 px-4">
              <Ico d={P.shield} sz="w-3.5 h-3.5" /> Institutional Grade
            </span>
          </div>
        </Card>
      </div>
        ...
        <Card cls="overflow-hidden">
          ...
          <div className="px-6 sm:px-8 pt-6 sm:pt-8 pb-5 border-b border-gray-100">
            <div className="flex items-start gap-4">
              <div
                ...
                style={{ backgroundColor: NAVYLT }}
              >
                <Ico d={P.doc} sz="w-5 h-5" st={NAVY} />
              </div>
              <div>
                <p className="text-xs text-gray-400 uppercase tracking-widest font-semibold">
                  Confidential Report · Wealth Strategy Group
                </p>
                <h2 className="text-lg sm:text-xl font-extrabold text-gray-900 mt-0.5">
                  Personalized Retirement Strategy
                </h2>
                <p className="text-xs text-gray-400 mt-0.5">
                  Prepared for {props.payload.clientName || "Client"} · {new Date().toLocaleDateString("en-US", { month: "long", year: "numeric" })}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="px-6 sm:px-8 py-6 space-y-8">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 leading-relaxed">
                Based on your current financial trajectory and the goals outlined in your discovery
                session, your retirement plan shows strong resilience. This summary provides a
                high-level overview of your readiness, projected asset growth, and diversified income
                streams. Your strategy is designed to maintain your lifestyle while mitigating
                long-term market volatility and inflation risks.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="rounded-xl p-5"
                ...
                <div className="flex items-baseline gap-2 mb-1">
                  ...
                  <span className="text-xs font-bold px-2 py-0.5 rounded-full text-green-700 bg-green-100">
                    On Track
                  </span>
                </div>
                <p className="text-xs text-gray-400 leading-relaxed">
                  Your probability of meeting all retirement spending goals through age 95, including
                  healthcare and legacy objectives.
                </p>
              </div>
              <div className="rounded-xl p-5 text-white" style={{ backgroundColor: NAVY }}>
                <div className="flex items-center gap-2 mb-2">
                  <Ico d={P.shield} sz="w-4 h-4" />
                  <span className="text-xs font-bold">Institutional Confidence</span>
                </div>
                <p className="text-xs opacity-75 leading-relaxed">
                  Analysis based on 10,000 Monte Carlo simulations using current market data.
                </p>
              </div>
            </div>
                ...
                <table className="w-full text-xs min-w-max">
                  ...
                  <tbody className="divide-y divide-gray-50">
                    {assets.map(function (a) {
                      return (
                        <tr key={a.label}>
                          <td className="py-3 text-gray-600">{a.label}</td>
                          <td className="py-3 text-right text-gray-700 font-medium">{a.current}</td>
                          <td className="py-3 text-right text-gray-700 font-medium">{a.target}</td>
                        </tr>
                      );
                    })}
                    <tr className="border-t-2 border-gray-200">
                      <td className="pt-3 font-bold" style={{ color: NAVY }}>Total Portfolio</td>
                      <td className="pt-3 text-right font-extrabold" style={{ color: NAVY }}>$3,115,000</td>
                      <td className="pt-3 text-right font-extrabold" style={{ color: NAVY }}>$4,650,000</td>
                    </tr>
                  </tbody>
                </table>
              </div>
                  ...
                  return (
                    <div key={s.label}>
                      <div className="flex items-center justify-between mb-1.5">
                        ...
                        <span className="text-xs font-semibold text-gray-500">{s.amount}</span>
                      </div>
          ...
          {/* Report footer */}
          <div
            className="px-6 sm:px-8 py-4 flex flex-wrap items-center justify-between gap-2 border-t border-gray-100"
          ...
          >
            ...
            <p className="text-xs text-gray-400 uppercase tracking-widest flex items-center gap-1">
              <Ico d={P.lock} sz="w-3 h-3" /> Restricted
            </p>
          </div>
        </Card>
      </div>
  ...
  return (
    <div className="flex flex-col items-center justify-center py-10">
      <div className="w-full max-w-xl">
        ...
        <h1 className="text-xl sm:text-2xl font-extrabold text-gray-900 text-center mb-2">
          Final Review & Acknowledgment
        </h1>
        <p className="text-sm text-gray-400 text-center mb-8">
          Please review the following disclosure to finalize your retirement plan.
        </p>

        <Card cls="p-6 sm:p-8">
          <div
            className="rounded-xl px-5 sm:px-6 py-5 mb-6 text-center"
            style={{ backgroundColor: "#f7f9fc", border: "1px solid #e4e9f2" }}
          >
            <p className="text-sm text-gray-600 italic leading-relaxed">
              "I understand this plan is for educational and planning purposes only and does not
          ...
          <button
            ...
            style={{
              ...
              opacity: agreed && !isLoading ? 1 : 0.4,
              cursor: agreed && !isLoading ? "pointer" : "not-allowed",
            }}
          >
            {isLoading ? "Submitting..." : "Generate My Retirement Plan"}
            {!isLoading && <Ico d={P.chart} sz="w-4 h-4" st="white" />}
          </button>
        ...
        <div className="mt-6 text-center space-y-2">
          <div className="flex items-center justify-center gap-6">
            <span className="flex items-center gap-1.5 text-xs text-gray-400">
              <Ico d={P.chart} sz="w-3.5 h-3.5" />
              <span className="uppercase tracking-widest font-semibold">Institutional Grade</span>
            </span>
            <span className="flex items-center gap-1.5 text-xs text-gray-400">
              <Ico d={P.lock} sz="w-3.5 h-3.5" />
              <span className="uppercase tracking-widest font-semibold">Secure Transmission</span>
            </span>
          </div>
          <p className="text-xs text-gray-400 max-w-xs mx-auto leading-relaxed">
            Your data is protected by bank-level 256-bit encryption. We do not share your personal
            financial details with third parties without explicit consent.
          </p>
        </div>
      </div>
    </div>
...
export default function RetirementPlan() {
  ...
  /* ── Unified form state (all steps share this) ── */
  ...
  function buildPayload(fd) {
    ...
    var retIncome = parseMoney(fd.retirementIncome);
    var monthlyContrib = fd.contribUnit === "%"
      ? Math.round((salary * (parseFloat(fd.contribRate) || 0) / 100) / 12)
      : (parseFloat(fd.contribRate) || 0);
    ...
    var yearsToRetire = Math.max(retireAgeNum - currentAge, 0);
    var annReturnNum = parseFloat(fd.annReturn) / 100 || 0.07;
    var salaryGrowth = 0.03;

    /* Simple FV projection: FV = PV*(1+r)^n + PMT*[((1+r)^n - 1)/r] */
    function fv(pv, pmt, rate, n) {
      if (n <= 0) return pv;
      if (rate === 0) return pv + pmt * n;
      var factor = Math.pow(1 + rate, n);
      return pv * factor + pmt * 12 * ((factor - 1) / rate);
    }

    var projectedPortfolio = Math.round(
      fv(planBal + iraBal + taxSav, monthlyContrib, annReturnNum, yearsToRetire)
    );
    ...
    /* Social Security rough estimate: ~$2,333/mo at 67 based on avg earnings */
    var ssa67 = Math.round(salary * 0.29);
    var ssa70 = Math.round(ssa67 * 1.24);

    /* Inflation: salary at retirement */
    var salaryFuture = Math.round(salary * Math.pow(1 + fd.inflationRate, yearsToRetire));

    /* Net worth */
    var totalAssets = planBal + iraBal + taxSav;
    var netWorth = totalAssets; /* simplified — no liabilities from form */
    ...
    var efundStatus = Math.round((parseMoney(fd.iraBal) / recommendedEFund) * 100);
    ...
    return {
      ...
      /* Plans */
      participatesInPlan: fd.participates,
      planTypes: fd.planTypes,
      retirementSavings: planBal,
      monthlyContribution: monthlyContrib,
      employerMatch: empMatchNum,
      expectedAnnualReturn: annReturnNum,
      continueUntilRetirement: fd.contUntilRet,

      /* IRAs */
      hasIRA: fd.hasIRA,
      iraTypes: fd.iraTypes,
      iraBalance: iraBal,
      annualIRAContribution: parseMoney(fd.iraContrib),
      taxableSavings: taxSav,
      additionalIncomeSources: fd.incomeSrc,

      /* Goals */
      targetRetirementIncome: retIncome,
      lifestyle: fd.lifestyle,
      confidenceScore: fd.confidence,
      inflationSensitivity: fd.inflation,
      ...
      efundStatus: Math.min(efundStatus, 100),

      /* Debt */
      dtiRatio: 32,

      /* Investment allocation (defaults — no form field) */
      ...
      /* Action plan */
      actionPlan: [
        "Increase retirement contribution to " + (Math.max(parseInt(fd.contribRate) + 4, 12)) + "%",
  ...
  function goNext() {
    ...
    if (completedSteps.indexOf(id) === -1) {
      setCompletedSteps(function (prev) { return prev.concat(id); });
    }
  ...
  function renderStep() {
    if (currentStep === "profile") {
      return <Profile data={formData} setData={setFormData} onNext={goNext} />;
    }
    if (currentStep === "income") {
      return <Income data={formData} setData={setFormData} onNext={goNext} onPrev={goPrev} />;
    }
    if (currentStep === "plans") {
      return <Plans data={formData} setData={setFormData} onNext={goNext} onPrev={goPrev} />;
    }
    if (currentStep === "iras") {
      return <IRAs data={formData} setData={setFormData} onNext={goNext} onPrev={goPrev} />;
    }
    if (currentStep === "goals") {
      return <Goals data={formData} setData={setFormData} onNext={goNext} onPrev={goPrev} />;
    }
